		...
		<table id="myTable" class="table table-striped table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo ($usuario->estatus_did == 1) ? '<span class="label label-success">' . $usuario->estatus->tipo. '</span>' :
	            							'<span class="label label-danger">' . $usuario->estatus->tipo . '</span>'; ?></td>
					<td>
            ...
            <?php echo CHtml::link('Editar',array('usuario/update','id'=>$usuario->id),array('class'=>'btn btn-success btn-sm')); ?>
						<?php echo ($usuario->estatus_did == 1) ? 
												CHtml::link('No publicar',array('usuario/cambiar','id'=>$usuario->id,'estatus'=>2),array('class'=>'btn btn-danger btn-sm')) : 
												CHtml::link('Publicar',array('usuario/cambiar','id'=>$usuario->id,'estatus'=>1),array('class'=>'btn btn-primary btn-sm')); ?>						
          </td>	
				</tr>
				<?php } ?>
			</tbody>
