			...
			<div class="widget-body">
				...
				<div class="">
					<ul class="nav nav-tabs">
						<li class="active">
							<a href="#tab<?php echo $proyecto->id; ?>1" data-toggle="tab">Pendientes <span class="badge bg-color-blueDark txt-color-white"><?php echo count($actividadesPendientes); ?></span></a>
						</li>
						<li >
							<a href="#tab<?php echo $proyecto->id; ?>2" data-toggle="tab">Hechas <span class="badge bg-color-greenDark txt-color-white"><?php echo count($actividadesRealizadas); ?></span></a>
						</li>						
						<li>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab<?php echo $proyecto->id; ?>1">
							<table class="table table-striped table-bordered">
								...
								<tbody>
									<?php $c=0; foreach($actividadesPendientes as $ar){ $c++; ?>
									<tr>
										<td><?php echo $c;?></td>
						...
						<div class="tab-pane" id="tab<?php echo $proyecto->id; ?>2">
							<table class="table table-striped table-bordered">
								...
								<tbody>
									<?php $c=0; foreach($actividadesRealizadas as $ap){ $c++; ?>
									<tr>
										<td><?php echo $c;?></td>
